...
const About = () => {
  return (
    <div className='flex flex-col justify-center gap-9 bg-background py-40'>
      ...
      <div className='flex flex-col md:flex-row md:gap-30 justify-center gap-10 px-10'>
        <div className='w-[500px] sm:w-[400px] md:w-[600px]'>
        ...
        <div className='w-[700px]'>
          ...
          <div className="grid grid-cols-4 gap-8 w-[600px] items-center rounded-b-md hover:drop-shadow-[0_15px_35px_rgba(0,185,255,0.4)] transition-drop-shadow duration-300">
